...
// template-app), this shows only what template has: a space selector (to switch
// spaces, like sneat-app) and the selected space's lists.
@Component({
  selector: 'template-space-menu',
  templateUrl: './template-space-menu.component.html',
  imports: [
    TitleCasePipe,
    RouterLink,
    SpaceServiceModule,
  ...
  providers: [
    { provide: ClassName, useValue: 'TemplateSpaceMenuComponent' },
    SpaceComponentBaseParams,
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class TemplateSpaceMenuComponent extends SpaceBaseComponent {
