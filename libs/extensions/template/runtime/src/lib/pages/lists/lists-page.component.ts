...
export class ListsPageComponent extends SpaceBaseComponent {
  private readonly params = inject(TemplateComponentBaseParams);
  ...
  constructor() {
    ...
    this.templateAppStateService.changed.subscribe((appState) => {
  ...
  public clickGroup(group: IListGroup): void {
    ...
    this.templateAppStateService.setGroupCollapsed(
      group.title,
